export default function AboutMe() {
  return (
    <section className="mb-10 max-w-3xl">
      ...
      <div className="text-neutral-300 leading-relaxed text-base md:text-lg space-y-3">
        <p>
          Hi, I'm <span className="font-semibold text-white">Laurentiu Lupsa</span>, a <span className="text-white font-semibold">Full Stack Web Developer</span>. I'm passionate about technology, web development, and building real solutions that make a difference.
        </p>
        <p>
