import pingPriceLogo from '../assets/pingprice-logo.png';
...
const experienceList = [
  {
    logo: pingPriceLogo,
    position: "Reflex Developer (Full-Time, Intern)",
    company: "PingPrice",
    location: "Brussels, Belgium",
    period: "August 2025 - October 2025",
    responsibilities: [
      "Developed business dashboards using Reflex (Python).",
      "Built interfaces for sales analytics and product performance monitoring across multiple European retail markets.",
      "Built reusable UI components and optimized application performance.",
      "Worked with REST APIs to integrate data into dashboards.",
      "Collaborated with design and back-end teams to deliver responsive, user-friendly solutions."
    ],
  },
  {
...
export default function Experience() {
  return (
    <section id="experience" className="mb-10 max-w-3xl scroll-mt-24">
